  ...
  return (
    <div className="fixed z-40 inset-0 flex items-center justify-center bg-gray-700/50">
      <div className="bg-surface px-6 pt-8 md:py-5 md:rounded-xl shadow-lg w-full h-full md:h-auto max-w-xl relative">
        ...
        <button
          type="button"
          className="absolute top-3 right-4 text-3xl text-secondary hover:text-gray-700"
          onClick={onCancel}
        >
          &times;
        </button>
        <div className="flex items-center justify-between pl-8 h-30 mb-2 rounded-lg border border-dashed border-gray-300">
          <p className="text-sm text-text-primary mr-4">Dark Mode</p>
