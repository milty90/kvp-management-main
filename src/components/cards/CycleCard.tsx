...
export default function CycleCard({
  ...
  return (
    <div
      className={`flex min-w-15 w-full items-center justify-around md:justify-between h-12 md:px-3  md:h-14 lg:gap-12 rounded-xl border-${color}-300/60 border shadow-md ${colorClasses[color]}`}
    >
