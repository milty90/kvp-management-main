...
export default function StatBar({ kvps }: StatBarProps) {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 w-full h-full min-h-0 content-start overflow-y-auto p-4 rounded-lg bg-white text-gray-800 gap-3 scrollbar-none">
      ...
      <div className="flex flex-col items-start rounded-lg border border-dashed border-gray-300 p-6 pb-0 ">
        ...
        <div className="flex w-full h-full mt-5 items-center justify-center pr-15">
